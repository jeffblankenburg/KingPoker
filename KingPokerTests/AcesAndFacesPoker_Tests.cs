...
{
    [TestClass]
    public class AcesAndFacesPoker_Tests
    {
        PokerGame pg;

        public void GameSetup(bool ShouldDeal = true)
        {
            pg = new PokerGame(GameType.AcesAndFacesPoker);
            if (ShouldDeal) pg.Deal();
        }

        [TestMethod]
        public void AcesAndFacesPoker_DeckCount()
        {
            GameSetup(false);
        ...
        [TestMethod]
        public void AcesAndFacesPoker_RoyalFlush()
        {
            GameSetup();
        ...
        [TestMethod]
        public void AcesAndFacesPoker_StraightFlush()
        {
            GameSetup();
        ...
        [TestMethod]
        public void AcesAndFacesPoker_FourAces()
        {
            GameSetup();
            pg.SetCardSuitAndValue(0, new Suit { ID = 1, Name = "Hearts" }, new CardValue { Number = 14, Name = "Ace" });
        ...
        [TestMethod]
        public void AcesAndFacesPoker_FourJsThruKs()
        {
            GameSetup();
            ...
            Assert.AreEqual(HandOutcome.FourJsThruKs, pg.CheckHandForOutcome());
        }

        [TestMethod]
        public void AcesAndFacesPoker_Four2sThru10s()
        {
            GameSetup();
            ...
            Assert.AreEqual(HandOutcome.Four2sThru10s, pg.CheckHandForOutcome());
        }

        [TestMethod]
        public void AcesAndFacesPoker_FullHouse()
        {
            GameSetup();
        ...
        [TestMethod]
        public void AcesAndFacesPoker_Flush()
        {
            GameSetup();
        ...
        [TestMethod]
        public void AcesAndFacesPoker_Straight()
        {
            GameSetup();
        ...
        [TestMethod]
        public void AcesAndFacesPoker_ThreeOfAKind()
        {
            GameSetup();
        ...
        [TestMethod]
        public void AcesAndFacesPoker_TwoPair()
        {
            GameSetup();
            pg.SetCardSuitAndValue(0, new Suit { ID = 1, Name = "Hearts" }, new CardValue { Number = 2, Name = "Two" });
            pg.SetCardSuitAndValue(1, new Suit { ID = 2, Name = "Diamonds" }, new CardValue { Number = 13, Name = "King" });
        ...
        [TestMethod]
        public void AcesAndFacesPoker_JacksOrBetter()
        {
            GameSetup();
