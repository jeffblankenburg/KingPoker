...
{
    [TestClass]
    public class DoubleBonusPoker_Tests
    {
        PokerGame pg;

        public void GameSetup(bool ShouldDeal = true)
        {
            pg = new PokerGame(GameType.DoubleBonusPoker);
            if (ShouldDeal) pg.Deal();
        }

        [TestMethod]
        public void DoubleBonusPoker_DeckCount()
        {
            GameSetup(false);
        ...
        [TestMethod]
        public void DoubleBonusPoker_RoyalFlush()
        {
            GameSetup();
        ...
        [TestMethod]
        public void DoubleBonusPoker_StraightFlush()
        {
            GameSetup();
        ...
        [TestMethod]
        public void DoubleBonusPoker_FourAces()
        {
            GameSetup();
            pg.SetCardSuitAndValue(0, new Suit { ID = 1, Name = "Hearts" }, new CardValue { Number = 14, Name = "Ace" });
        ...
        [TestMethod]
        public void DoubleBonusPoker_Four2sThru4s()
        {
            GameSetup();
        ...
        [TestMethod]
        public void DoubleBonusPoker_Four5sThruKings()
        {
            GameSetup();
        ...
        [TestMethod]
        public void DoubleBonusPoker_FullHouse()
        {
            GameSetup();
        ...
        [TestMethod]
        public void DoubleBonusPoker_Flush()
        {
            GameSetup();
        ...
        [TestMethod]
        public void DoubleBonusPoker_Straight()
        {
            GameSetup();
        ...
        [TestMethod]
        public void DoubleBonusPoker_ThreeOfAKind()
        {
            GameSetup();
        ...
        [TestMethod]
        public void DoubleBonusPoker_TwoPair()
        {
            GameSetup();
            pg.SetCardSuitAndValue(0, new Suit { ID = 1, Name = "Hearts" }, new CardValue { Number = 2, Name = "Two" });
            pg.SetCardSuitAndValue(1, new Suit { ID = 2, Name = "Diamonds" }, new CardValue { Number = 13, Name = "King" });
        ...
        [TestMethod]
        public void DoubleBonusPoker_JacksOrBetter()
        {
            GameSetup();
