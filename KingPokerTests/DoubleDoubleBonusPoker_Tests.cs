...
namespace KingPokerTests
{
    ...
    public class DoubleDoubleBonusPoker_Tests
    {
        ...
        {
            pg = new PokerGame(GameType.DoubleDoubleBonusPoker);
            if (ShouldDeal) pg.Deal();
        }

        [TestMethod]
        public void DoubleDoubleBonusPoker_DeckCount()
        {
            GameSetup(false);
        ...
        [TestMethod]
        public void DoubleDoubleBonusPoker_RoyalFlush()
        {
            GameSetup();
        ...
        [TestMethod]
        public void DoubleDoubleBonusPoker_StraightFlush()
        {
            GameSetup();
            pg.SetCardSuitAndValue(0, new Suit { ID = 1, Name = "Hearts" }, new CardValue { Number = 14, Name = "Ace" });
        ...
        [TestMethod]
        public void DoubleDoubleBonusPoker_FourAcesWith2Thru4()
        {
            GameSetup();
            pg.SetCardSuitAndValue(0, new Suit { ID = 1, Name = "Hearts" }, new CardValue { Number = 14, Name = "Ace" });
        ...
        [TestMethod]
        public void DoubleDoubleBonusPoker_FourAcesWith5_ShouldBeJustFourAces()
        {
            GameSetup();
            pg.SetCardSuitAndValue(0, new Suit { ID = 1, Name = "Hearts" }, new CardValue { Number = 14, Name = "Ace" });
            pg.SetCardSuitAndValue(1, new Suit { ID = 2, Name = "Diamonds" }, new CardValue { Number = 14, Name = "Ace" });
        ...
        [TestMethod]
        public void DoubleDoubleBonusPoker_Four2sThru4sWithAThru4()
        {
            GameSetup();
        ...
        [TestMethod]
        public void DoubleDoubleBonusPoker_Four2sThru4sWith7_ShouldBeJustFour2sThru4s()
        {
            GameSetup();
        ...
        [TestMethod]
        public void DoubleDoubleBonusPoker_FourAces()
        {
            GameSetup();
            pg.SetCardSuitAndValue(0, new Suit { ID = 1, Name = "Hearts" }, new CardValue { Number = 14, Name = "Ace" });
            pg.SetCardSuitAndValue(1, new Suit { ID = 2, Name = "Diamonds" }, new CardValue { Number = 14, Name = "Ace" });
            pg.SetCardSuitAndValue(2, new Suit { ID = 3, Name = "Clubs" }, new CardValue { Number = 9, Name = "Nine" });
            pg.SetCardSuitAndValue(3, new Suit { ID = 4, Name = "Spades" }, new CardValue { Number = 14, Name = "Ace" });
            pg.SetCardSuitAndValue(4, new Suit { ID = 3, Name = "Clubs" }, new CardValue { Number = 14, Name = "Ace" });
            Assert.AreEqual(HandOutcome.FourAces, pg.CheckHandForOutcome());
        }
        ...
        [TestMethod]
        public void DoubleDoubleBonusPoker_Four2sThru4s()
        {
            GameSetup();
            pg.SetCardSuitAndValue(0, new Suit { ID = 1, Name = "Hearts" }, new CardValue { Number = 3, Name = "Three" });
            pg.SetCardSuitAndValue(1, new Suit { ID = 2, Name = "Diamonds" }, new CardValue { Number = 3, Name = "Three" });
        ...
        [TestMethod]
        public void DoubleDoubleBonusPoker_Four5sThruKings()
        {
            GameSetup();
        ...
        [TestMethod]
        public void DoubleDoubleBonusPoker_FullHouse()
        {
            GameSetup();
        ...
        [TestMethod]
        public void DoubleDoubleBonusPoker_Flush()
        {
            GameSetup();
        ...
        [TestMethod]
        public void DoubleDoubleBonusPoker_Straight()
        {
            GameSetup();
        ...
        [TestMethod]
        public void DoubleDoubleBonusPoker_ThreeOfAKind()
        {
            GameSetup();
            pg.SetCardSuitAndValue(0, new Suit { ID = 1, Name = "Hearts" }, new CardValue { Number = 4, Name = "Four" });
            pg.SetCardSuitAndValue(1, new Suit { ID = 2, Name = "Diamonds" }, new CardValue { Number = 12, Name = "Queen" });
        ...
        [TestMethod]
        public void DoubleDoubleBonusPoker_TwoPair()
        {
            GameSetup();
        ...
        [TestMethod]
        public void DoubleDoubleBonusPoker_JacksOrBetter()
        {
            GameSetup();
