...
namespace KingPokerTests
{
    ...
    public class SuperAcesBonusPoker
    {
        ...
        {
            pg = new PokerGame(GameType.SuperAcesBonusPoker);
            if (ShouldDeal) pg.Deal();
        }

        [TestMethod]
        public void SuperAcesBonusPoker_DeckCount()
        {
            GameSetup(false);
        ...
        [TestMethod]
        public void SuperAcesBonusPoker_RoyalFlush()
        {
            GameSetup();
        ...
        [TestMethod]
        public void SuperAcesBonusPoker_StraightFlush()
        {
            GameSetup();
        ...
        [TestMethod]
        public void SuperAcesBonusPoker_FourAces()
        {
            GameSetup();
            pg.SetCardSuitAndValue(0, new Suit { ID = 1, Name = "Hearts" }, new CardValue { Number = 14, Name = "Ace" });
        ...
        [TestMethod]
        public void SuperAcesBonusPoker_Four2sThru4s()
        {
            GameSetup();
        ...
        [TestMethod]
        public void SuperAcesBonusPoker_Four5sThruKings()
        {
            GameSetup();
        ...
        [TestMethod]
        public void SuperAcesBonusPoker_FullHouse()
        {
            GameSetup();
        ...
        [TestMethod]
        public void SuperAcesBonusPoker_Flush()
        {
            GameSetup();
        ...
        [TestMethod]
        public void SuperAcesBonusPoker_Straight()
        {
            GameSetup();
        ...
        [TestMethod]
        public void SuperAcesBonusPoker_ThreeOfAKind()
        {
            GameSetup();
        ...
        [TestMethod]
        public void SuperAcesBonusPoker_TwoPair()
        {
            GameSetup();
            pg.SetCardSuitAndValue(0, new Suit { ID = 1, Name = "Hearts" }, new CardValue { Number = 2, Name = "Two" });
            pg.SetCardSuitAndValue(1, new Suit { ID = 2, Name = "Diamonds" }, new CardValue { Number = 13, Name = "King" });
        ...
        [TestMethod]
        public void SuperAcesBonusPoker_JacksOrBetter()
        {
            GameSetup();
