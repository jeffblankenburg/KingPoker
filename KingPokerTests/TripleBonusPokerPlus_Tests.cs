...
{
    [TestClass]
    public class TripleBonusPokerPlus_Tests
    {
        PokerGame pg;

        public void GameSetup(bool ShouldDeal = true)
        {
            pg = new PokerGame(GameType.TripleBonusPokerPlus);
            if (ShouldDeal) pg.Deal();
        }

        [TestMethod]
        public void TripleBonusPokerPlus_DeckCount()
        {
            GameSetup(false);
        ...
        [TestMethod]
        public void TripleBonusPokerPlus_RoyalFlush()
        {
            GameSetup();
        ...
        [TestMethod]
        public void TripleBonusPokerPlus_StraightFlush()
        {
            GameSetup();
        ...
        [TestMethod]
        public void TripleBonusPokerPlus_FourAces()
        {
            GameSetup();
            pg.SetCardSuitAndValue(0, new Suit { ID = 1, Name = "Hearts" }, new CardValue { Number = 14, Name = "Ace" });
        ...
        [TestMethod]
        public void TripleBonusPokerPlus_Four2sThru4s()
        {
            GameSetup();
        ...
        [TestMethod]
        public void TripleBonusPokerPlus_Four5sThruKings()
        {
            GameSetup();
        ...
        [TestMethod]
        public void TripleBonusPokerPlus_FullHouse()
        {
            GameSetup();
        ...
        [TestMethod]
        public void TripleBonusPokerPlus_Flush()
        {
            GameSetup();
        ...
        [TestMethod]
        public void TripleBonusPokerPlus_Straight()
        {
            GameSetup();
        ...
        [TestMethod]
        public void TripleBonusPokerPlus_ThreeOfAKind()
        {
            GameSetup();
        ...
        [TestMethod]
        public void TripleBonusPokerPlus_TwoPair()
        {
            GameSetup();
            pg.SetCardSuitAndValue(0, new Suit { ID = 1, Name = "Hearts" }, new CardValue { Number = 2, Name = "Two" });
            pg.SetCardSuitAndValue(1, new Suit { ID = 2, Name = "Diamonds" }, new CardValue { Number = 13, Name = "King" });
        ...
        [TestMethod]
        public void TripleBonusPokerPlus_JacksOrBetter()
        {
            GameSetup();
