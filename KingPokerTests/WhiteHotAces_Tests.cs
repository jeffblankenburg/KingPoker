...
{
    [TestClass]
    public class WhiteHotAces_Tests
    {
        PokerGame pg;

        public void GameSetup(bool ShouldDeal = true)
        {
            pg = new PokerGame(GameType.WhiteHotAces);
            if (ShouldDeal) pg.Deal();
        }

        [TestMethod]
        public void WhiteHotAces_DeckCount()
        {
            GameSetup(false);
        ...
        [TestMethod]
        public void WhiteHotAces_RoyalFlush()
        {
            GameSetup();
        ...
        [TestMethod]
        public void WhiteHotAces_StraightFlush()
        {
            GameSetup();
        ...
        [TestMethod]
        public void WhiteHotAces_FourAces()
        {
            GameSetup();
            pg.SetCardSuitAndValue(0, new Suit { ID = 1, Name = "Hearts" }, new CardValue { Number = 14, Name = "Ace" });
        ...
        [TestMethod]
        public void WhiteHotAces_Four2sThru4s()
        {
            GameSetup();
        ...
        [TestMethod]
        public void WhiteHotAces_Four5sThruKings()
        {
            GameSetup();
        ...
        [TestMethod]
        public void WhiteHotAces_FullHouse()
        {
            GameSetup();
        ...
        [TestMethod]
        public void WhiteHotAces_Flush()
        {
            GameSetup();
        ...
        [TestMethod]
        public void WhiteHotAces_Straight()
        {
            GameSetup();
        ...
        [TestMethod]
        public void WhiteHotAces_ThreeOfAKind()
        {
            GameSetup();
        ...
        [TestMethod]
        public void WhiteHotAces_TwoPair()
        {
            GameSetup();
            pg.SetCardSuitAndValue(0, new Suit { ID = 1, Name = "Hearts" }, new CardValue { Number = 2, Name = "Two" });
            pg.SetCardSuitAndValue(1, new Suit { ID = 2, Name = "Diamonds" }, new CardValue { Number = 13, Name = "King" });
        ...
        [TestMethod]
        public void WhiteHotAces_JacksOrBetter()
        {
            GameSetup();
